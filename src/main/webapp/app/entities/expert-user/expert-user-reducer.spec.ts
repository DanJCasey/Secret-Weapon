...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXPERTUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_EXPERTUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EXPERTUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EXPERTUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EXPERTUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EXPERTUSER actions', async () => {
      const expectedActions = [
        {
