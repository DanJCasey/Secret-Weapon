...
export const UserAccountDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="secretWeaponApp.userAccount.delete.question">
        <Translate contentKey="secretWeaponApp.userAccount.delete.question" interpolate={{ id: userAccountEntity.id }}>
